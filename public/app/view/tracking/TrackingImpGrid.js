...
let trackingimp_treestore = Ext.create('PHNet.store.shopping.Trackingimp', {
    storeId: 'trackingimptreestore'
});
Ext.define('PHNet.view.tracking.TrackingImpGrid', {
    extend: 'Ext.tree.Panel',
    alias: 'widget.trackingimpgrid',
    id: 'trackingimpgrid',
    requires: [
        'Ext.data.*',
        'Ext.grid.*',
    ...
    initComponent: function() {
        ...
        let me = this,
            cellEditingPlugin = Ext.create('Ext.grid.plugin.CellEditing', {
                pluginId: 'trackingimpgridEditing',
                clicksToEdit: 2
            });
        ...
        me.dockedItems = [{
            ...
            items: [{
                    ...
                    tooltip: 'Exportar a...',
                    menu: {
                        lid: 'trackingimpExportMenu',
                        items: [
                            { text: 'Informe Adobe PDF', itemId: 'trackingimpPDF', lid: 'trackingimpPDF', id: 'trackingimpPDF', iconCls: 'fas fa-file-pdf', height: 28 },
                            { text: 'Libro de Excel (*.xlsx)', itemId: 'trackingimpExcel', lid: 'trackingimpExcel', iconCls: 'fas fa-file-excel', height: 28 }
                        ]
                    }
                }, {
                    id: 'filterbtn',
                    ...
                    menu: {
                        ...
                        items: [{
                                ...
                                id: 'filter-trackimp-circuit',
                                itemId: 'filter-trackimp-circuit',
                                lid: 'filter-trackimp-circuit',
                                iconCls: 'fas fa-fingerprint icon-list',
                                menu: {
                                    id: 'filter-trackimp-circuit-menu',
                                    items: [{
                                        xtype: 'radiofield',
                            ...
                            { text: 'Filtros Avanzados...', itemId: 'trackingimpFilter', lid: 'trackingimpFilter', iconCls: 'fas fa-arrow-right icon-list', height: 28 },
                            { text: 'Borrar Filtros', hidden: true, id: 'menu-filter-remove', itemId: 'trackingimpNoFilter', lid: 'trackingimpNoFilter', iconCls: 'fas fa-times remove', height: 28 }
                        ]
                    }
                }, {
                    xtype: 'box',
        ...
        let work = Ext.getCmp('trackingimpworkcombo').getValue(),
            dpto = Ext.getCmp('trackingimpdptocombo').getValue();
        /*month = Ext.getCmp('trackingimpmonthcombo').getValue(),
        ...
        // Load Store
        let proxy = me.getStore().getProxy();
        Ext.apply(proxy.api, {
            read: '/phnet.compras/public/api/tracking/import/' + work + '/' + dpto /* +'/'+ month +'/'+ year*/
        });
        me.getStore().load();
